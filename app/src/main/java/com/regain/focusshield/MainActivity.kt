...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun refreshSelectedApps() {
            selectedApps.text = "Allowed apps: ${Prefs.allowed(this).size}"
        }
        ...
        accessibilityButton.setOnClickListener {
            try {
                ...
                // Settings is optional; do not crash if unavailable.
            }
        }
        ...
        focusButton.setOnClickListener {
            if (running) {
                ...
                running = true
                val end = System.currentTimeMillis() + focusDuration
                Prefs.setFocus(this, true, end)
                status.text = "Focus mode is active"
                focusButton.text = "Pause Focus"

                timer = object : CountDownTimer(focusDuration, 1000L) {
                    ...
                    override fun onFinish() {
                        resetUi()
                        status.text = "Focus session complete"
                    }
                }.start()
            }
        }
    ...
    override fun onResume() {
        super.onResume()
        findViewById<TextView>(R.id.selectedApps).text =
